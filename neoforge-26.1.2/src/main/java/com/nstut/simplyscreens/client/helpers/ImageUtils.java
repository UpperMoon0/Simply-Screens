...
public class ImageUtils {
    ...
    public static Identifier createTextureResource(BufferedImage image, String imageId) {
        if (image == null) {
        ...
        try {
            ...
            Identifier resourceLocation = Identifier.fromNamespaceAndPath(SimplyScreens.MOD_ID, textureId);

            Minecraft.getInstance().getTextureManager().register(resourceLocation, new DynamicTexture(() -> "Simply Screens image " + imageId, nativeImage));
