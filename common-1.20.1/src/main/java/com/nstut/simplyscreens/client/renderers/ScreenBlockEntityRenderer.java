...
public class ScreenBlockEntityRenderer implements BlockEntityRenderer<ScreenBlockEntity> {
    ...
    private void renderTextureQuad(ResourceLocation texture, ScreenTileLayout.Tile tile, PoseStack poseStack,
        ...
        VertexConsumer vertexBuffer = bufferSource.getBuffer(RenderType.textPolygonOffset(texture));
    ...
    private void buildTexturedQuad(VertexConsumer consumer, PoseStack.Pose pose, int overlay, ScreenTileLayout.Tile tile) {
        ...
        // Top-right vertex
        consumer.vertex(pose.pose(), tile.minX(), tile.maxY(), 0)
                .color(255, 255, 255, 255)
                .uv(tile.maxU(), tile.minV())
        ...
        // Top-left vertex
        consumer.vertex(pose.pose(), tile.maxX(), tile.maxY(), 0)
                .color(255, 255, 255, 255)
                .uv(tile.minU(), tile.minV())
                .overlayCoords(overlay)
                .uv2(FULL_BRIGHTNESS)
                .normal(pose.normal(), 0, 0, 1)
                .endVertex();
        ...
        // Bottom-left vertex
        consumer.vertex(pose.pose(), tile.maxX(), tile.minY(), 0)
                .color(255, 255, 255, 255)
                .uv(tile.minU(), tile.maxV())
                .overlayCoords(overlay)
                .uv2(FULL_BRIGHTNESS)
                .normal(pose.normal(), 0, 0, 1)
                .endVertex();
        ...
        // Bottom-right vertex
        consumer.vertex(pose.pose(), tile.minX(), tile.minY(), 0)
                .color(255, 255, 255, 255)
                .uv(tile.maxU(), tile.maxV())
                .overlayCoords(overlay)
                .uv2(FULL_BRIGHTNESS)
                .normal(pose.normal(), 0, 0, 1)
                .endVertex();
