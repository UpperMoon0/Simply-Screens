...
- **Packaging and runtime compatibility**:
  ...
  - Optional local Sable, Rapier, Create, Ponder, Flywheel, Registrate, and Veil runtime wiring is available for development integration tests; these local runtime artifacts are not bundled in release jars.
